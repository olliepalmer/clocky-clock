...
function change() { 
  ...
  var col1 = randomColor({/*luminosity:'light'*/});
  var col2 = randomColor({/*luminosity:'light'*/});
  var col3 = randomColor({/*luminosity:'light'*/});
  document.getElementById('hh').style.color = col1;
  document.getElementById('mm').style.color = col2;
  document.getElementById('ss').style.color = col3;
  
  // intense mode (uncomment)
  var col4 = randomColor({luminosity:'dark'});
  document.getElementById('bgd').style.background = col4;
}
